"""
BioOntology example: search.

NCBO BioOntology search API.

Requirements: the BIOPORTAL_API_KEY environment variable.

Run from the repository root:

    python docs/examples/ontologies/bioontology/bioontology_example.py
...
async def main() -> None:
    ...
    try:
        ...
        if SOURCE not in lookup.adapters:
            ...
            print("It needs the BIOPORTAL_API_KEY environment variable.")
            print("\nSummary: skipped")
            return
