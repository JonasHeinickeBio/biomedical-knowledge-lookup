"""
EBI OLS example: search and concept details.

EMBL-EBI OLS (a variant of the OLS adapter).

get_concept_details expects the full term IRI.

Requirements: none, this is a public API.

Run from the repository root:

    python docs/examples/ontologies/ebiols/ebiols_example.py
...
QUERY = "cancer"
CONCEPT_ID = "http://purl.obolibrary.org/obo/MONDO_0004992"
...
async def main() -> None:
    ...
    try:
        ...
        if SOURCE not in lookup.adapters:
            ...
            print("It needs no API key or extra; check your installation.")
            print("\nSummary: skipped")
            return
