"""
Example: Using the HPO Adapter for Biomedical Concept Lookup
"""
...
async def main():
    ...
    print(f"Checking if HPO adapter is available...")
    if lookup:
        print(f"  ✓ HPO adapter is available")
    else:
        print(f"  ✗ HPO adapter is not available")
        return
