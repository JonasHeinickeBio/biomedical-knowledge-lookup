"""
Tyto example: search and concept details.

Tyto term lookup in the SO, SBO and NCIT ontologies.

Search is an exact-label lookup; get_concept_details takes a term IRI.

Requirements: the [tyto] extra.

Run from the repository root:

    python docs/examples/other/tyto/tyto_example.py
...
QUERY = "promoter"
CONCEPT_ID = "http://purl.obolibrary.org/obo/SO_0000167"
