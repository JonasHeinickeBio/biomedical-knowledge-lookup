"""
COSMIC example: search.

COSMIC somatic cancer mutations. COSMIC has no public query API.

Requirements: COSMIC account credentials in the COSMIC_API_KEY environment variable.

Run from the repository root:

    python docs/examples/other/cosmic/cosmic_example.py
...
async def main() -> None:
    ...
    try:
        ...
        if SOURCE not in lookup.adapters:
            ...
            print(
                "It needs COSMIC account credentials in the COSMIC_API_KEY environment variable."
            )
            print("\nSummary: skipped")
            return
