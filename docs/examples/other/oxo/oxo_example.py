"""
OxO example: search and concept details.

EBI OxO ontology cross-reference mappings.

Search with a CURIE; the concept's mappings list its cross-references.

Requirements: none, this is a public API.

Run from the repository root:

    python docs/examples/other/oxo/oxo_example.py
