"""
OMIM example: search and concept details.

OMIM Mendelian disorders and genes.

Requirements: the OMIM_API_KEY environment variable.

Run from the repository root:

    python docs/examples/phenotypes/omim/omim_example.py
...
async def main() -> None:
    ...
    try:
        ...
        if SOURCE not in lookup.adapters:
            ...
            print("It needs the OMIM_API_KEY environment variable.")
            print("\nSummary: skipped")
            return
