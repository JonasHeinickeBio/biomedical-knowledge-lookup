"""
Example: Using the EuropePMC Adapter for Biomedical Concept Lookup
"""
...
async def main():
    ...
    print(f"Checking if EuropePMC adapter is available...")
    if lookup:
        print(f"  ✓ EuropePMC adapter is available")
    else:
        print(f"  ✗ EuropePMC adapter is not available")
        return
