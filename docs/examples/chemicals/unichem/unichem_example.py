"""
UniChem example: search and concept details.

UniChem chemical cross-references.

Search by InChIKey; get_concept_details takes a UniChem compound ID (UCI).

Requirements: the [bioservices] extra.

Run from the repository root:

    python docs/examples/chemicals/unichem/unichem_example.py
...
async def main() -> None:
    ...
    try:
        ...
        if SOURCE not in lookup.adapters:
            ...
            print("It needs the [bioservices] extra.")
            print("\nSummary: skipped")
            return
