"""
Open Targets example: search and concept details.

Open Targets Platform targets, diseases and drugs.

get_concept_details takes an Ensembl gene ID.

Requirements: none, this is a public API.

Run from the repository root:

    python docs/examples/core/opentargets/opentargets_example.py
