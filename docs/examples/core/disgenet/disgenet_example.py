"""
DisGeNET example: search.

DisGeNET gene-disease associations.

Queries can be a disease name, a gene symbol (CDK2) or an NCBI gene ID (1017).

Requirements: the DISGENET_API_KEY environment variable.

Run from the repository root:

    python docs/examples/core/disgenet/disgenet_example.py
...
async def main() -> None:
    ...
    try:
        ...
        if SOURCE not in lookup.adapters:
            ...
            print("It needs the DISGENET_API_KEY environment variable.")
            print("\nSummary: skipped")
            return
