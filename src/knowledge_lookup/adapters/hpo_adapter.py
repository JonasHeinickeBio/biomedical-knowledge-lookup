...
class HPOAdapter(KnowledgeSourceAdapter):
    ...
    def _convert_hpo_result_to_concept(self, result: Dict[str, Any]) -> Optional[UnifiedConcept]:
        ...
        try:
            ...
            concept.add_identifier(
                ...
                hpo_id,
                label,
                f"https://hpo.jax.org/app/browse/term/{hpo_id}"
            )
    ...
    def _convert_hpo_details_to_concept(self, details: Dict[str, Any]) -> Optional[UnifiedConcept]:
