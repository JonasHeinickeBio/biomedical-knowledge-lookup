...
class DrugBankAdapter(KnowledgeSourceAdapter):
    ...
    def _convert_drugbank_result_to_concept(self, result: Dict[str, Any]) -> Optional[UnifiedConcept]:
    ...
    def _convert_drugbank_details_to_concept(self, data: Dict[str, Any]) -> Optional[UnifiedConcept]:
