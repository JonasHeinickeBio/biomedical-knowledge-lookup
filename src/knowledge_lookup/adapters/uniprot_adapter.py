...
class UniProtAdapter(KnowledgeSourceAdapter):
    ...
    def _convert_uniprot_result_to_concept(self, result: Dict[str, Any]) -> Optional[UnifiedConcept]:
        ...
        try:
            ...
            recommended_name = protein_description.get('recommendedName', {}).get('fullName', {}).get('value', '')
