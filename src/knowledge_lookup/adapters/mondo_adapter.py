...
class MondoAdapter(KnowledgeSourceAdapter):
    ...
    def _convert_mondo_result_to_concept(self, result: Dict[str, Any]) -> Optional[UnifiedConcept]:
    ...
    def _convert_mondo_details_to_concept(self, data: Dict[str, Any]) -> Optional[UnifiedConcept]:
