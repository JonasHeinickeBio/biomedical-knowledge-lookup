...
class ConceptIdentifier(ConfiguredBaseModel):
    ...
    source: KnowledgeSource = Field(default=..., description="""The knowledge source""", json_schema_extra = { "linkml_meta": {'domain_of': ['ConceptIdentifier', 'ConceptMapping', 'SourceAnnotation']} })
...
class ConceptMapping(ConfiguredBaseModel):
    ...
    source: Optional[str] = Field(default=None, description="""Source of the mapping""", json_schema_extra = { "linkml_meta": {'domain_of': ['ConceptIdentifier', 'ConceptMapping', 'SourceAnnotation']} })
...
class UnifiedConcept(ConfiguredBaseModel):
    ...
    labels: Optional[list[str]] = Field(default=None, description="""Labels in different languages""", json_schema_extra = { "linkml_meta": {'domain_of': ['UnifiedConcept']} })
...
class LookupResult(ConfiguredBaseModel):
    ...
    errors: Optional[list[str]] = Field(default=None, description="""Dictionary of errors per source""", json_schema_extra = { "linkml_meta": {'domain_of': ['LookupResult']} })
...
class LookupConfig(ConfiguredBaseModel):
    ...
    rate_limits: Optional[list[float]] = Field(default=None, description="""Rate limits per source (requests per second)""", json_schema_extra = { "linkml_meta": {'domain_of': ['LookupConfig']} })
    ...
    api_keys: Optional[list[str]] = Field(default=None, description="""API keys for external services""", json_schema_extra = { "linkml_meta": {'domain_of': ['LookupConfig']} })
...
class SourceAnnotation(ConfiguredBaseModel):
    ...
    positions: Optional[list[str]] = Field(default=None, description="""List of position dictionaries""", json_schema_extra = { "linkml_meta": {'domain_of': ['SourceAnnotation']} })
...
class MultiSourceAnnotationResult(ConfiguredBaseModel):
    ...
    discrepancies: Optional[list[str]] = Field(default=None, description="""List of discrepancies""", json_schema_extra = { "linkml_meta": {'domain_of': ['MultiSourceAnnotationResult']} })
    ...
    annotation_stats: Optional[str] = Field(default=None, description="""Annotation statistics""", json_schema_extra = { "linkml_meta": {'domain_of': ['MultiSourceAnnotationResult']} })
