...
class UMLSConceptService:
                ...
                try:
                    ...
                    if isinstance(definitions_data, str):
                        ...
                        try:
                            ...
                            if (
                                isinstance(definitions_result, dict)
                                and "results" in definitions_result
                            ):
                                definitions = [
                                    defn.get("value", "") for defn in definitions_result["results"]
                                ]
                        except Exception as e:
    ...
    def get_concept_atoms(self, cui: str, source: str | None = None) -> list[dict[str, Any]]:
        ...
        params = {"pageSize": "25"}  # Add pagination to improve performance
    ...
    def get_concept_hierarchy(self, cui: str, levels: int = 1) -> dict[str, Any]:
        ...
        """
        result: dict[str, Any] = {"cui": cui, "parents": [], "children": []}
