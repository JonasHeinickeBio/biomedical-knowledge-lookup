...
class TestUMLSClientIntegration:
    ...
    async def test_complete_semantic_analysis_workflow(self):
        ...
        async with UMLSStringConceptClient(self.api_key) as string_client:
            ...
            string_client.get_concepts_for_string = AsyncMock(return_value=[
                {"cui": "C0011847", "name": "Diabetes Mellitus", "score": 0.95}
            ])
        ...
        async with UMLSCodeLookupClient(self.api_key) as code_client:
            code_client.get_codes_for_cui = AsyncMock(return_value=[
                {"cui": cui, "code": "250.00", "vocab_abbr": "ICD9CM", "term": "Diabetes mellitus"}
            ])
        ...
        async with UMLSSemanticTypesClient(self.api_key) as semantic_client:
            semantic_client.get_semantic_types_for_string = AsyncMock(return_value=[
                {"search_string": "diabetes", "cui": cui, "semantic_type": "Disease or Syndrome"}
            ])
    ...
    async def test_bidirectional_concept_code_mapping(self):
        ...
        async with UMLSCodeLookupClient(self.api_key) as code_client:
            code_client.get_codes_for_cui = AsyncMock(return_value=[
                {"cui": "C0011847", "code": "250.00", "vocab_abbr": "ICD9CM"}
            ])
        ...
        async with UMLSConceptLookupClient(self.api_key) as concept_client:
            concept_client.get_concepts_for_code = AsyncMock(return_value=[
    ...
    async def test_vocabulary_crosswalk_integration(self):
        ...
        async with UMLSCrosswalkClient(self.api_key) as crosswalk_client:
            ...
            crosswalk_client.get_crosswalk_for_code = AsyncMock(return_value=[
                {
                    "source_code": "250.00",
                    "source_vocab": "ICD9CM",
                    "target_code": "E11.9",
    ...
    async def test_parallel_client_processing(self):
        ...
        async def get_semantic_types():
            async with UMLSSemanticTypesClient(self.api_key) as client:
                client.get_semantic_types_for_strings = AsyncMock(return_value={"total_processed": 3})
    ...
    async def test_file_processing_pipeline(self):
        ...
        try:
            ...
            async with UMLSStringConceptClient(self.api_key) as string_client:
                string_client.get_concepts_for_strings = AsyncMock(return_value=type('Result', (), {
                    'mappings': [
                        type('Mapping', (), {'cui': 'C0011847', 'search_string': 'diabetes'}),
                        type('Mapping', (), {'cui': 'C0020538', 'search_string': 'hypertension'}),
                        type('Mapping', (), {'cui': 'C0004096', 'search_string': 'asthma'})
                    ]
                })())
            ...
            async with UMLSCodeLookupClient(self.api_key) as code_client:
                code_client.get_codes_for_cuis = AsyncMock(return_value=type('Result', (), {
                    'mappings': [
    ...
    async def test_performance_optimization_features(self):
        ...
        async with UMLSSemanticTypesClient(
            ...
            tasks = [
                client.get_semantic_types_for_string(term)
    ...
    async def test_real_world_medical_terminology_workflow(self):
        ...
        async with UMLSSemanticTypesClient(self.api_key) as semantic_client:
            semantic_client.get_semantic_types_for_strings = AsyncMock(return_value=type('Result', (), {
                'mappings': [
                    type('Mapping', (), {
                        'search_string': term,
                        'cui': f'C{i:07d}',
...
class TestClientResourceManagement:
    ...
    async def test_error_recovery_across_clients(self):
        ...
        results = await asyncio.gather(*[
            test_client_error_recovery(client_class)
