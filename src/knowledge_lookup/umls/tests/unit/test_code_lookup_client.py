...
class TestCodeLookupResult:
    ...
    def test_success_rate_calculation(self):
        ...
        successful_mapping = CodeMapping(
            cui="C0011847",
            code="250.00",
            vocab_abbr="ICD9CM"
        )
        
        failed_mapping = CodeMapping(
            cui="C0000000",
...
class TestUMLSCodeLookupClient:
    ...
    async def test_make_request_success(self):
        ...
        mock_response_data = {
            "result": {
                "results": [
                    {"ui": "250.00", "name": "Diabetes mellitus"}
                ]
            }
        }
    ...
    async def test_get_codes_for_cuis_multiple(self):
        ...
        async with UMLSCodeLookupClient(self.api_key) as client:
            ...
            client.get_codes_for_cui = AsyncMock(side_effect=[
                [CodeMapping(cui="C0011847", code="250.00", vocab_abbr="ICD9CM")],
                [CodeMapping(cui="C0020538", code="401.9", vocab_abbr="ICD9CM")]
            ])
            
            result = await client.get_codes_for_cuis(
                ["C0011847", "C0020538"]
            )
    ...
    def test_vocabulary_name_mapping(self):
        ...
        assert client._get_vocabulary_name("ICD9CM") == "International Classification of Diseases, Ninth Revision, Clinical Modification"
        assert client._get_vocabulary_name("ICD10CM") == "International Classification of Diseases, 10th Revision, Clinical Modification"
