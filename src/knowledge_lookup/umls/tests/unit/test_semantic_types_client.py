...
class TestSemanticTypeMapping:
    ...
    def test_failed_mapping(self):
        ...
        mapping = SemanticTypeMapping(
            search_string="invalidterm", error_message="No results found"
        )
...
class TestSemanticTypesResult:
    ...
    def test_success_rate_calculation(self):
        ...
        successful_mapping = SemanticTypeMapping(search_string="diabetes", cui="C0011847")

        failed_mapping = SemanticTypeMapping(search_string="invalid", error_message="Not found")
    ...
    def test_to_dataframe(self):
        ...
        mapping = SemanticTypeMapping(
            search_string="diabetes", cui="C0011847", ui="D003920", name="Diabetes Mellitus"
        )
...
class TestUMLSSemanticTypesClient:
    ...
    def test_custom_initialization(self):
        ...
        client = UMLSSemanticTypesClient(
            api_key="custom_key", version="2023AA", max_concurrent_requests=20, request_delay=0.05
        )
    ...
    async def test_make_request_success(self):
        ...
        mock_response_data = {
            "result": {"results": [{"ui": "C0011847", "name": "Diabetes Mellitus"}]}
        }
        ...
        async with UMLSSemanticTypesClient(self.api_key) as client:
            ...
            result = await client._make_request("https://test.com/api", {"string": "diabetes"})
    ...
    async def test_make_request_error(self):
        ...
        async with UMLSSemanticTypesClient(self.api_key) as client:
            ...
            with pytest.raises(aiohttp.ClientError):
                await client._make_request("https://test.com/api", {"string": "diabetes"})

    @pytest.mark.asyncio
    async def test_search_string_success(self):
        """Test successful string search."""
        mock_search_response = {"result": {"results": [{"ui": "C0011847"}, {"ui": "C0011849"}]}}
    ...
    async def test_search_string_no_results(self):
        ...
        mock_search_response: dict[str, Any] = {"result": {"results": []}}
    ...
    async def test_get_semantic_types_success(self):
        ...
        async with UMLSSemanticTypesClient(self.api_key) as client:
            ...
            ui, name, semantic_type, semantic_type_uri = await client._get_semantic_types(
                "C0011847"
            )
    ...
    async def test_get_semantic_types_for_string_success(self):
        ...
        async with UMLSSemanticTypesClient(self.api_key) as client:
            ...
            client._get_semantic_types = AsyncMock(
                return_value=("C0011847", "Diabetes Mellitus", "Disease or Syndrome", "T047")
            )
    ...
    async def test_get_semantic_types_for_strings_multiple(self):
        ...
        async with UMLSSemanticTypesClient(self.api_key) as client:
            ...
            client.get_semantic_types_for_string = AsyncMock(
                side_effect=[
            ...
            result = await client.get_semantic_types_for_strings(["diabetes", "hypertension"])
    ...
    def test_save_result_json(self):
        ...
        mapping = SemanticTypeMapping(search_string="diabetes", cui="C0011847")
    ...
    def test_save_result_unsupported_format(self):
        ...
        result = SemanticTypesResult(search_strings=[], mappings=[], total_processed=0)
